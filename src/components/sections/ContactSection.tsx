...
export default function ContactSection() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      alert("😬🫣 Une erreur s'est produite lors de l'envoi de l'email. 😳🤯 \n Veuillez réessayer plus tard, ou contacter moi directement à l'adresse suivante: paulinewashukenyi@gmail.com 😊");
    }
  };
  return (
    <section className="section4 h-[90vh] flex justify-center items-center scroll-mt-[10vh] snap-start">
      <article className="w-[90%] h-[90%] border-2 border-slate-950 p-4 rounded-sm flex flex-col justify-center items-center relative fade">
        <SectionTitle title="Contact" color="bg-orange-700" className="relative -top-10" />
        <form
        ...
        >
          <div className="h-full flex flex-col">
            ...
            <div className="h-full flex flex-col gap-4 md:justify-center md:col-start-2 md:col-span-2 ">
              <span className="flex flex-col gap-2">
              ...
              <span className="flex flex-col gap-2 h-full">
                ...
                <textarea
                  ...
                  className="border-2 border-black h-full p-1"
                />
              </span>
            </div>
            </div>
